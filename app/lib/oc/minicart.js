...
function minicart() {
    ...
    function template(){
        return [
            '<style>',
            '.minicart { padding: 15px 15px 15px 0; float: right; cursor: pointer;color: #FFF; min-width:300px; text-align:right;}',
            ...
            '.minicart .label.label-default {border-top-right-radius: 0;border-top-left-radius: 0;border-bottom-right-radius: 0;border-bottom-left-radius: 0;background-color: #5cb85c;}',
            ...
            '.minicart .minicart-detail {display: none;border-radius: 4px;-webkit-box-shadow: 0px 6px 12px 0px rgba(0, 0, 0, 0.176);box-shadow: 0 6px 12px 0 rgba(0, 0, 0, 0.8); padding: 10px;position: absolute;top: 100%;right: 10px; background-color: rgba(31, 31, 31, 0.9); z-index: 20;}',
            ...
            '.minicart .minicart-detail .row:not(.lineitem-row):not(.top-item) {border-top: 1px solid #ddd;}',
